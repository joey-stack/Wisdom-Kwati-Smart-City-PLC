...
export default function Page() {
    ...
    <div id="gallery-lightbox" className="hd-lightbox" aria-hidden="true">
        ...
        <div className="hd-lightbox-caption">
            <strong>The Black Onyx</strong> &mdash; Adamawa
        </div>
        ...
        <div className="hd-lightbox-thumbs" id="lb-thumbs">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1xDix9g0as7V5dV9U_uggWnkr_kdl5SpX%26sz=w1200" alt="1" data-index="0" referrerPolicy="no-referrer" />
            ...
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1xDix9g0as7V5dV9U_uggWnkr_kdl5SpX%26sz=w1200"  alt="5" data-index="4" referrerPolicy="no-referrer" />
        </div>

        {/*  Hidden full src list  */}
        <div id="lb-srcs" style={{ display: "none" }}>
            <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1xDix9g0as7V5dV9U_uggWnkr_kdl5SpX%26sz=w1200</span> <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1low4QaMMGv78ejUu8fu4jGET-05Ou612%26sz=w1200</span> <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1pZw-Bbw-n7F6cLhweMXVkXN8EDU0mlIT%26sz=w1200</span> <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ%26sz=w1200</span> <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1xDix9g0as7V5dV9U_uggWnkr_kdl5SpX%26sz=w1200</span>
    </div>
    </div>
        <div className="hd-hero-image">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1xDix9g0as7V5dV9U_uggWnkr_kdl5SpX%26sz=w1200" alt="The Black Onyx" referrerPolicy="no-referrer" />
        </div>
        ...
        <div className="hd-hero-content reveal-on-scroll">
            <div className="hd-hero-location">
                ...
                Sangere Numa, Adamawa
                <div className="hd-location-dot"></div>
            </div>
            <h1 className="hd-hero-title">The Black Onyx</h1>
            <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "18px", letterSpacing: "0.05em", opacity: "0.9", marginTop: "-10px" }}>3 Bedroom Bungalow</p>
        </div>
    </section>
        ...
        <div className="hd-specs-bar-wrapper">
            <div className="hd-specs-bar">
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">2,200 sq ft</span>
                </div>
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">450 SQM</span>
                </div>
                <div className="hd-spec-item">
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">1 story</span>
                </div>
                <div className="hd-spec-item">
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">WKSC-OX-001</span>
                </div>
            </div>
        ...
        <div className="hd-main-grid">
            ...
            <div className="hd-left-col">
                ...
                <section className="hd-description reveal-on-scroll">
                    <p className="hd-description-text">The Black Onyx is a modern bungalow designed for comfort and accessibility. With its sleek design and functional layout, it offers a perfect blend of style and practicality.</p>
                </section>

                {/*  Bento Gallery  */}
                <section className="hd-gallery reveal-on-scroll">
                    <div className="hd-gallery-item hd-gal-1">
                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1xDix9g0as7V5dV9U_uggWnkr_kdl5SpX%26sz=w1200" alt="Property View 1" referrerPolicy="no-referrer" />
                    </div>
                    ...
                    <div className="hd-gallery-item hd-gal-4">
                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ%26sz=w1200" alt="Property View 4" referrerPolicy="no-referrer" />
                    </div>
                    <div className="hd-gallery-item hd-gal-5">
                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1xDix9g0as7V5dV9U_uggWnkr_kdl5SpX%26sz=w1200" alt="Property View 5" referrerPolicy="no-referrer" />
                    </div>
                ...
                <section className="hd-amenities-section reveal-on-scroll">
                    ...
                    <div className="hd-amenities-grid">
                        ...
                        <div className="hd-amenity-tag"><i className="fa-solid fa-solar-panel"></i> Solar Panels</div>
                        ...
                        <div className="hd-amenity-tag"><i className="fa-solid fa-road"></i> Paved Roads</div>
                    </div>
                </section>
                ...
                <div className="hd-sidebar">
                    ...
                    <div className="hd-inquiry-box reveal-on-scroll">
                        ...
                        <form className="hd-inquiry-form">
                            ...
                            <div className="hd-form-group">
                                <textarea rows="4" placeholder="I'm interested in The Black Onyx. Please provide more details."></textarea>
                            </div>
