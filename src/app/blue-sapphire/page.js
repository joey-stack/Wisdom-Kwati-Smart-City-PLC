...
export default function Page() {
    ...
    <div id="gallery-lightbox" className="hd-lightbox" aria-hidden="true">
        ...
        <div className="hd-lightbox-caption">
            <strong>The Blue Sapphire</strong> &mdash; Karsana
        </div>
        ...
        <div className="hd-lightbox-thumbs" id="lb-thumbs">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ%26sz=w1200" alt="1" data-index="0" referrerPolicy="no-referrer" />
        ...
        <div className="hd-hero-content reveal-on-scroll">
            ...
            <h1 className="hd-hero-title">The Blue Sapphire</h1>
            <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "18px", letterSpacing: "0.05em", opacity: "0.9", marginTop: "-10px" }}>4 Bedroom Fully Detached Duplex</p>
        </div>
    </section>
        ...
        <div className="hd-specs-bar-wrapper">
            <div className="hd-specs-bar">
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">4,200 sq ft</span>
                </div>
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">500 SQM</span>
                </div>
                <div className="hd-spec-item">
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">WKSC-SA-002</span>
                </div>
            </div>
        ...
        <div className="hd-main-grid">
            ...
            <div className="hd-left-col">
                ...
                <section className="hd-description reveal-on-scroll">
                    <p className="hd-description-text">The Blue Sapphire is a masterpiece of modern architecture, offering spacious interiors and state-of-the-art amenities. Perfect for those who seek luxury in a serene environment.</p>
                </section>

                {/*  Bento Gallery  */}
                <section className="hd-gallery reveal-on-scroll">
                    <div className="hd-gallery-item hd-gal-1">
                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ%26sz=w1200" alt="Property View 1" referrerPolicy="no-referrer" />
                    </div>
                    ...
                    <div className="hd-gallery-item hd-gal-3">
                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1pZw-Bbw-n7F6cLhweMXVkXN8EDU0mlIT%26sz=w1200" alt="Property View 3" referrerPolicy="no-referrer" />
                    </div>
                    ...
                    <div className="hd-gallery-item hd-gal-5">
                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ%26sz=w1200" alt="Property View 5" referrerPolicy="no-referrer" />
                    </div>
                ...
                <section className="hd-amenities-section reveal-on-scroll">
                    ...
                    <div className="hd-amenities-grid">
                        <div className="hd-amenity-tag"><i className="fa-solid fa-water"></i> Private Pool</div>
                        <div className="hd-amenity-tag"><i className="fa-solid fa-solar-panel"></i> Solar Energy</div>
                        <div className="hd-amenity-tag"><i className="fa-solid fa-video"></i> Smart Surveillance</div>
                        <div className="hd-amenity-tag"><i className="fa-solid fa-shield-halved"></i> 24/7 Security</div>
                        <div className="hd-amenity-tag"><i className="fa-solid fa-bolt"></i> Constant Power</div>
                        <div className="hd-amenity-tag"><i className="fa-solid fa-leaf"></i> Lush Gardens</div>
                    </div>
                </section>
                ...
                <div className="hd-sidebar">
                    ...
                    <div className="hd-inquiry-box reveal-on-scroll">
                        ...
                        <form className="hd-inquiry-form">
                            ...
                            <div className="hd-form-group">
                                <textarea rows="4" placeholder="I'm interested in The Blue Sapphire. Please provide more details."></textarea>
                            </div>
    ...
    <section className="hd-related-section reveal-on-scroll">
        <div className="hd-container">
            ...
            <div className="portfolio-grid" id="related-properties-grid">
                ...
                {/*  Related Listing 2: Royal Emerald  */}
