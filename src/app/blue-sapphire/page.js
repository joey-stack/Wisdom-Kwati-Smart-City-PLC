...
export default function Page() {
    ...
    <div id="gallery-lightbox" className="hd-lightbox" aria-hidden="true">
        ...
        <div className="hd-lightbox-thumbs" id="lb-thumbs">
            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ" alt="1" data-index="0" />
            ...
            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1VBqCbd9wcYZK-027SKQoy1-t1eofVjdL" alt="4" data-index="3" />
            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ"  alt="5" data-index="4" />
        </div>
        ...
        <div className="hd-hero-image">
            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ" alt="The Blue Sapphire" />
        </div>
            ...
            <div className="hd-left-col">
                ...
                <section className="hd-gallery reveal-on-scroll">
                    <div className="hd-gallery-item hd-gal-1">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ" alt="Property View 1" />
                    </div>
                    ...
                    <div className="hd-gallery-item hd-gal-4">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1VBqCbd9wcYZK-027SKQoy1-t1eofVjdL" alt="Property View 4" />
                    </div>
                    <div className="hd-gallery-item hd-gal-5">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ" alt="Property View 5" />
                    </div>
            ...
            <div className="portfolio-grid" id="related-properties-grid">
                ...
                <a href="/imperial-emerald" className="ht-card reveal-on-scroll"
                    ...
                    <div className="ht-card-image">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1pZw-Bbw-n7F6cLhweMXVkXN8EDU0mlIT" alt="The Imperial Emerald" onError={(e) => { e.currentTarget.src = 'https://images.weserv.nl/?url=drive.google.com/uc?id=1UD9Y32e13MOoV8CRibkuC5bBgHbTzoam'; }} />
                    </div>
                ...
                <a href="/royal-emerald" className="ht-card reveal-on-scroll"
                    ...
                    <div className="ht-card-image">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1low4QaMMGv78ejUu8fu4jGET-05Ou612" alt="The Royal Emerald" onError={(e) => { e.currentTarget.src = 'https://images.weserv.nl/?url=drive.google.com/uc?id=1UD9Y32e13MOoV8CRibkuC5bBgHbTzoam'; }} />
                    </div>
                    <div className="ht-card-info">
                        <div className="ht-card-left">
