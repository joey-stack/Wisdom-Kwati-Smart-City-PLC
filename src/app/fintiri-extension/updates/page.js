            ...
            <div className="container-1380" style={{ padding: "60px 20px" }}>
                ...
                <div className="gallery-grid reveal-on-scroll">
                    ...
                    <div className="gallery-item skeleton">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1UD9Y32e13MOoV8CRibkuC5bBgHbTzoam" alt="Fintiri Extension Site Update" loading="lazy" />
                    </div>
                    <div className="gallery-item skeleton">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1B3cgNstWKQojqadbYfvYhldFT961GRPK" alt="Fintiri Extension Site Update" loading="lazy" />
                    </div>
                    <div className="gallery-item skeleton">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1LYF8aZZPnWhg3my_LJH_GOPzy4AEKppk" alt="Fintiri Extension Site Update" loading="lazy" />
                    </div>
                    <div className="gallery-item skeleton">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1WyUxduCtGKp5W4B5xZ1liHas9U1oz-3r" alt="Fintiri Extension Site Update" loading="lazy" />
                    </div>
                    <div className="gallery-item skeleton">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1UD9Y32e13MOoV8CRibkuC5bBgHbTzoam" alt="Fintiri Extension Site Update" loading="lazy" />
                    </div>
