...
export default function Page() {
    ...
    <section className="pd-hero">
        <div className="pd-hero-image">
            <img src="https://images.weserv.nl/?url=https://drive.google.com/uc?id=1K9BgIgXG_xT9slAfRl32icd95C1bmoOz" alt="The HOF Community" />
        </div>
                    ...
                    <a href="/katampe-extension" className="pd-compact-item">
                        <div className="pd-compact-flipper">
                            <div className="pd-compact-front">
                                <img src="https://images.weserv.nl/?url=https://drive.google.com/uc?id=1FKHV1OKlto7dJFQqUk-xjlu4-M7w4vFN" alt="Whispering Pines" className="pd-compact-thumb" />
