...
export default function Page() {
    ...
    <main className="ht-main-content" style={{ paddingTop: "140px", paddingBottom: "80px" }}>
        {/*  Hero Section  */}
        ...
        <section className="ht-filter-section">
            <div className="container container-1380">
                <div className="ht-filter-bar reveal-on-scroll">
                    ...
                    {/*  Search: House Type Name  */}
                    <div className="ht-filter-item">
                        <label><i className="fa-solid fa-magnifying-glass" style={{ fontSize: "10px" }}></i> SEARCH BY NAME</label>
                        <div className="ht-select-wrapper ht-search-wrapper">
                            <input type="text" id="filter-search" placeholder="e.g. The Emerald..." />
                        </div>
                    </div>
                    ...
                    <div className="ht-filter-action">
                        <button className="ht-filter-reset-btn" id="filter-reset">
                            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> RESET FILTERS
                        </button>
                    </div>
                </div>
            ...
            <div className="container container-1380">
                <div className="ht-grid" id="ht-grid">
                    ...
                    <a href="/star-sapphire" className="ht-card reveal-on-scroll"
                        ...
                        <div className="ht-card-image">
                            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=19sBRWuZx6VQ-enPz4-9UlWgyfrGLKVX-" alt="The Star Sapphire" onError={(e) => { e.currentTarget.src = '/assets/services_project_image.png'; }} />
                        </div>
                        <div className="ht-card-info">
                            <div className="ht-card-left">
                    ...
                    <a href="/white-sapphire" className="ht-card reveal-on-scroll"
                        ...
                        <div className="ht-card-image">
                            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1A7k_VT1u7aBo45A3bDqgo86Cgl7xRRow" alt="The White Sapphire" onError={(e) => { e.currentTarget.src = '/assets/services_project_image.png'; }} />
                        </div>
                        <div className="ht-card-info">
                            <div className="ht-card-left">
                    ...
                    <a href="/black-onyx" className="ht-card reveal-on-scroll"
                        ...
                        <div className="ht-card-image">
                            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1xDix9g0as7V5dV9U_uggWnkr_kdl5SpX" alt="The Black Onyx" onError={(e) => { e.currentTarget.src = '/assets/services_project_image.png'; }} />
                        </div>
                        <div className="ht-card-info">
                            <div className="ht-card-left">
                    ...
                    <a href="/red-onyx" className="ht-card reveal-on-scroll"
                        ...
                        <div className="ht-card-image">
                            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1EvTJIVwYq5NcbH33A3opCXBuNFyWNS92" alt="The Red Onyx" onError={(e) => { e.currentTarget.src = '/assets/services_project_image.png'; }} />
                        </div>
                        <div className="ht-card-info">
                            <div className="ht-card-left">
                    ...
                    <a href="/silver-pearl" className="ht-card reveal-on-scroll"
                        ...
                        <div className="ht-card-image">
                            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D" alt="The Silver Pearl" onError={(e) => { e.currentTarget.src = '/assets/services_project_image.png'; }} />
                        </div>
                        <div className="ht-card-info">
                            <div className="ht-card-left">
                    ...
                    <a href="/white-pearl" className="ht-card reveal-on-scroll"
                        ...
                        <div className="ht-card-image">
                            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1YpYFPwZQUCf0k9tWJp13Y1kYzKe7npmJ" alt="The White Pearl" onError={(e) => { e.currentTarget.src = '/assets/services_project_image.png'; }} />
                        </div>
                        <div className="ht-card-info">
                            <div className="ht-card-left">
