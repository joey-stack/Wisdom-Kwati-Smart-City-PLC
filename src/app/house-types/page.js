                    ...
                    <div className="container container-1380">
                        <div className="ht-grid" id="ht-grid">
                            ...
                            <a href="/star-sapphire" className="ht-card reveal-on-scroll"
                                ...
                                <div className="ht-card-image">
                                    <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=19sBRWuZx6VQ-enPz4-9UlWgyfrGLKVX-" alt="The Star Sapphire" onError={(e) => { e.currentTarget.src = 'https://images.weserv.nl/?url=drive.google.com/uc?id=1VBqCbd9wcYZK-027SKQoy1-t1eofVjdL'; }} />
                                </div>
                                <div className="ht-card-info">
                                    <div className="ht-card-left">
                            ...
                            <a href="/blue-sapphire" className="ht-card reveal-on-scroll"
                                ...
                                <div className="ht-card-image">
                                    <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ" alt="The Blue Sapphire" onError={(e) => { e.currentTarget.src = 'https://images.weserv.nl/?url=drive.google.com/uc?id=1VBqCbd9wcYZK-027SKQoy1-t1eofVjdL'; }} />
                                </div>
                                <div className="ht-card-info">
                                    <div className="ht-card-left">
                            ...
                            <a href="/white-sapphire" className="ht-card reveal-on-scroll"
                                ...
                                <div className="ht-card-image">
                                    <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1A7k_VT1u7aBo45A3bDqgo86Cgl7xRRow" alt="The White Sapphire" onError={(e) => { e.currentTarget.src = 'https://images.weserv.nl/?url=drive.google.com/uc?id=1VBqCbd9wcYZK-027SKQoy1-t1eofVjdL'; }} />
                                </div>
                                <div className="ht-card-info">
                                    <div className="ht-card-left">
                            ...
                            <a href="/black-onyx" className="ht-card reveal-on-scroll"
                                ...
                                <div className="ht-card-image">
                                    <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1xDix9g0as7V5dV9U_uggWnkr_kdl5SpX" alt="The Black Onyx" onError={(e) => { e.currentTarget.src = 'https://images.weserv.nl/?url=drive.google.com/uc?id=1VBqCbd9wcYZK-027SKQoy1-t1eofVjdL'; }} />
                                </div>
                                <div className="ht-card-info">
                                    <div className="ht-card-left">
                            ...
                            <a href="/red-onyx" className="ht-card reveal-on-scroll"
                                ...
                                <div className="ht-card-image">
                                    <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1EvTJIVwYq5NcbH33A3opCXBuNFyWNS92" alt="The Red Onyx" onError={(e) => { e.currentTarget.src = 'https://images.weserv.nl/?url=drive.google.com/uc?id=1VBqCbd9wcYZK-027SKQoy1-t1eofVjdL'; }} />
                                </div>
                                <div className="ht-card-info">
                                    <div className="ht-card-left">
                            ...
                            <a href="/silver-pearl" className="ht-card reveal-on-scroll"
                                ...
                                <div className="ht-card-image">
                                    <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D" alt="The Silver Pearl" onError={(e) => { e.currentTarget.src = 'https://images.weserv.nl/?url=drive.google.com/uc?id=1VBqCbd9wcYZK-027SKQoy1-t1eofVjdL'; }} />
                                </div>
                                <div className="ht-card-info">
                                    <div className="ht-card-left">
                            ...
                            <a href="/white-pearl" className="ht-card reveal-on-scroll"
                                ...
                                <div className="ht-card-image">
                                    <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1YpYFPwZQUCf0k9tWJp13Y1kYzKe7npmJ" alt="The White Pearl" onError={(e) => { e.currentTarget.src = 'https://images.weserv.nl/?url=drive.google.com/uc?id=1VBqCbd9wcYZK-027SKQoy1-t1eofVjdL'; }} />
                                </div>
                                <div className="ht-card-info">
                                    <div className="ht-card-left">
