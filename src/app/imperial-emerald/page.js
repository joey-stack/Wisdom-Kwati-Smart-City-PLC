...
export default function Page() {
    ...
    <div id="gallery-lightbox" className="hd-lightbox" aria-hidden="true">
        ...
        <div className="hd-lightbox-caption">
            <strong>The Imperial Emerald</strong> &mdash; Maitama II
        </div>
        ...
        <div className="hd-lightbox-thumbs" id="lb-thumbs">
            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1pZw-Bbw-n7F6cLhweMXVkXN8EDU0mlIT" alt="1" data-index="0" />
            <img src="/assets/luxury_villas_mega_menu_1775684356585.png" alt="2" data-index="1" />
            <img src="/assets/about_hero_bg.png" alt="3" data-index="2" />
            <img src="/assets/services_project_image.png" alt="4" data-index="3" />
            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1pZw-Bbw-n7F6cLhweMXVkXN8EDU0mlIT"  alt="5" data-index="4" />
        </div>
        ...
        <div id="lb-srcs" style={{ display: "none" }}>
            ...
            <span>/assets/luxury_villas_mega_menu_1775684356585.png</span>
        ...
        <div className="hd-hero-image">
            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1pZw-Bbw-n7F6cLhweMXVkXN8EDU0mlIT" alt="The Imperial Emerald" />
        </div>
        ...
        <div className="hd-hero-content reveal-on-scroll">
            ...
            <h1 className="hd-hero-title">The Imperial Emerald</h1>
            <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "18px", letterSpacing: "0.05em", opacity: "0.9", marginTop: "-10px" }}>7 Bedroom Fully Detached Duplex</p>
        </div>
    </section>
        ...
        <div className="hd-specs-bar-wrapper">
            <div className="hd-specs-bar">
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">1,000 SQM</span>
                </div>
                <div className="hd-spec-item">
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">3 stories</span>
                </div>
                <div className="hd-spec-item">
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">WKSC-EM-001</span>
                </div>
            </div>
        ...
        <div className="hd-main-grid">
            ...
            <div className="hd-left-col">
                ...
                <section className="hd-description reveal-on-scroll">
                    <p className="hd-description-text">Experience the pinnacle of luxury with The Imperial Emerald. This architectural masterpiece features expansive living spaces, a private elevator, and a double-volume foyer that sets the tone for unmatched prestige. Built for the modern elite, it integrates state-of-the-art smart home automation with sustainable energy solutions.</p>
                </section>

                {/*  Bento Gallery  */}
                <section className="hd-gallery reveal-on-scroll">
                    <div className="hd-gallery-item hd-gal-1">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1pZw-Bbw-n7F6cLhweMXVkXN8EDU0mlIT" alt="Property View 1" />
                    </div>
                    <div className="hd-gallery-item hd-gal-2">
                        <img src="/assets/luxury_villas_mega_menu_1775684356585.png" alt="Property View 2" />
                    </div>
                    <div className="hd-gallery-item hd-gal-3">
                        <img src="/assets/about_hero_bg.png" alt="Property View 3" />
                    </div>
                    ...
                    <div className="hd-gallery-item hd-gal-5">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1pZw-Bbw-n7F6cLhweMXVkXN8EDU0mlIT" alt="Property View 5" />
                    </div>
                ...
                <section className="hd-estate-section reveal-on-scroll">
                    ...
                    <div className="hd-estate-grid">
                        ...
                        <a href="/katampe-extension" className="hd-estate-tag">
                            <i className="fa-solid fa-location-dot"></i>
                            Sunset Haven
                        </a>
                    </div>
                ...
                <div className="hd-sidebar">
                    ...
                    <div className="hd-inquiry-box reveal-on-scroll">
                        ...
                        <form className="hd-inquiry-form">
                            ...
                            <div className="hd-form-group">
                                <textarea rows="4" placeholder="I'm interested in The Imperial Emerald. Please provide more details."></textarea>
                            </div>
