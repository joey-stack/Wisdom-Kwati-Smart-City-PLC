...
export default function Page() {
    ...
    <div id="gallery-lightbox" className="hd-lightbox" aria-hidden="true">
        ...
        <div className="hd-lightbox-caption">
            <strong>The Jade</strong> &mdash; Guzape II Estate, Guzape II
        </div>
        ...
        <div className="hd-hero-image">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ%26sz=w1200" alt="The Jade" referrerPolicy="no-referrer" />
        </div>
        ...
        <div className="hd-hero-content reveal-on-scroll">
            <div className="hd-hero-location">
                ...
                Guzape II Estate, Guzape II
                <div className="hd-location-dot"></div>
            </div>
            <h1 className="hd-hero-title">The Jade</h1>
        ...
        <div className="hd-specs-bar-wrapper">
            <div className="hd-specs-bar">
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">2,900 sq ft</span>
                </div>
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">WKSC-JD-009</span>
                </div>
            </div>
        ...
        <div className="hd-main-grid">
            ...
            <div className="hd-left-col">
                ...
                <section className="hd-description reveal-on-scroll">
                    <p className="hd-description-text">Green living meets urban luxury in The Jade. Located in the exclusive Guzape II district, this 4-bedroom terrace duplex offers a serene escape from the city with its private gardens and eco-friendly infrastructure. Designed for those who value health, peace, and prestige.</p>
                </section>
                ...
                <div className="hd-sidebar">
                    ...
                    <div className="hd-inquiry-box reveal-on-scroll">
                        ...
                        <form className="hd-inquiry-form">
                            ...
                            <div className="hd-form-group">
                                <textarea rows="4" placeholder="I'm interested in The Jade. Please provide more details."></textarea>
                            </div>
