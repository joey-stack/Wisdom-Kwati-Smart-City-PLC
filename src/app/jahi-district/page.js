...
export default function Page() {
    ...
    <section className="pd-hero">
        <div className="pd-hero-image">
            <img src="/assets/neighborhood_jahi_1776023854572.png" alt="Jahi District" />
        </div>
        <div className="pd-hero-overlay"></div>
        <div className="pd-hero-content reveal-on-scroll">
            <h1 className="pd-hero-title">Jahi District</h1>
            <p className="pd-hero-description">A centrally located smart district offering a blend of commercial vibrancy and residential serenity in the heart of Abuja.</p>
            <a href="/jahi-district/updates" className="btn-pill" style={{ marginTop: "30px", display: "inline-flex", background: "var(--accent-green)", color: "var(--text-primary)", border: "none" }}>
    ...
    <main className="container-1380">
        <div className="pd-main-layout">
            ...
            <div className="pd-left-col">
                ...
                <section className="pd-section reveal-on-scroll">
                    <p style={{ fontSize: "20px", lineHeight: "1.6", color: "var(--text-primary)", marginBottom: "40px" }}>
                        Jahi District is Abuja's bridge between the bustle of the city center and the serenity of suburban living. Strategically positioned, it offers professionals and families a balanced urban experience with high-fidelity infrastructure and seamless connectivity to major business hubs.
                    </p>
                    
                    <div className="pd-section-title">District Highlights</div>
                    <ul className="pd-highlights">
                        
            <li>Underground power grid & smart street lighting</li>
            <li>Dedicated fiber-optic internet infrastructure</li>
            <li>Advanced drainage and sewage management systems</li>
            <li>24/7 Gated security & perimeter AI surveillance</li>
            <li>Urban green belts and recreational walkways</li>
            ...
            <tr><td className="pd-label-cell">Security Level</td><td>High / Rapid Response Patrols</td></tr>
            <tr><td className="pd-label-cell">Infrastructure</td><td>Modern Urban Smart Grid</td></tr>
            <tr><td className="pd-label-cell">Atmosphere</td><td>Professional / Dynamic / Secure</td></tr>
            ...
            <tr><td className="pd-label-cell">Health</td><td>Turkish Nizamye Hospital</td><td>15 mins</td></tr>
            <tr><td className="pd-label-cell">Shopping</td><td>Jabi Lake Mall</td><td>10 mins</td></tr>
            <tr><td className="pd-label-cell">Aviation</td><td>Airport</td><td>30 mins</td></tr>
            <tr><td className="pd-label-cell">Education</td><td>Regent Secondary School</td><td>10 mins</td></tr>
            ...
            <tr><td className="pd-label-cell">Standard Plots</td><td>₦35M – ₦75M</td><td>Steady Capital Appreciation</td></tr>
            <tr><td className="pd-label-cell">Corner Plots</td><td>₦80M – ₦130M</td><td>High Rental Yield Potential</td></tr>
            <tr><td className="pd-label-cell">Estate Lots (Bulk)</td><td>₦150M – ₦400M+</td><td>Developer Grade Investment</td></tr>
                ...
                <div className="pd-sidebar-card reveal-on-scroll" style={{ marginTop: "40px", background: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: "4px", padding: "24px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "16px" }}>
                        ...
                        <div>
                            ...
                            <p style={{ fontSize: "13px", color: "var(--text-secondary)", margin: "0" }}>Jahi District Specialist</p>
                        </div>
                    </div>
                    <p style={{ fontSize: "14px", color: "var(--text-secondary)", lineHeight: "1.6", marginBottom: "20px" }}>&ldquo;Jahi offers the perfect balance of central proximity and modern smart living. Let's find your spot in this vibrant district.&rdquo;</p>
