...
export default function Page() {
    ...
    <section className="pd-hero">
        <div className="pd-hero-image">
            <img src="/assets/whispering_pine_hero_clean.jpg" alt="Whispering Pines" />
        </div>
        <div className="pd-hero-overlay"></div>
        <div className="pd-hero-content reveal-on-scroll">
            <h1 className="pd-hero-title">Whispering Pines</h1>
            <p className="pd-hero-description">A family-centric smart district focused on sustainability, green spaces, and community-driven innovation in Abuja.</p>
            <a href="/karsana-district/updates" className="btn-pill" style={{ marginTop: "30px", display: "inline-flex", background: "var(--accent-green)", color: "var(--text-primary)", border: "none" }}>
            ...
            <div className="pd-left-col">
                ...
                <section className="pd-section reveal-on-scroll">
                    <p style={{ fontSize: "20px", lineHeight: "1.6", color: "var(--text-primary)", marginBottom: "40px" }}>
                        Karsana Smart District is designed for the modern Nigerian family. Situated in a rapidly growing corridor of the FCT, this district emphasizes "life in balance"—integrating solar energy, pedestrian-friendly streets, and expansive recreational parks into a secure residential ecosystem.
                    </p>
                    
                    <div className="pd-section-title">District Highlights</div>
                    <ul className="pd-highlights">
                        <li>Solar-powered street lighting & common area grids</li>
                        <li>Centralized smart water management & filtration</li>
                        <li>Dedicated pedestrian walkways and bicycle lanes</li>
                        <li>Automated access control & 24/7 security monitoring</li>
                        <li>Community parks with children's play zones & sports courts</li>
                    </ul>
                </section>
                        ...
                        <table className="pd-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Next Cash & Carry</td>
                                    <td>8 mins</td>
                                </tr>
                                <tr>
                                    <td className="pd-label-cell">Aviation</td>
                                    <td>Nnamdi Azikiwe International</td>
                                    <td>40 mins</td>
                                </tr>
                                <tr>
                                    <td className="pd-label-cell">Transport</td>
                                    <td>Abuja Metro Rail Station</td>
                                    <td>15 mins</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <a href="/katampe-extension" className="pd-compact-item">
                        <div className="pd-compact-flipper">
                            <div className="pd-compact-front">
                                <img src="/assets/neighborhood_katampe_1776023833571.png" alt="Katampe" className="pd-compact-thumb" />
                ...
                <div className="pd-sidebar-card reveal-on-scroll" style={{ marginTop: "40px", background: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: "4px", padding: "24px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "16px" }}>
                        ...
                        <div>
                            ...
                            <p style={{ fontSize: "13px", color: "var(--text-secondary)", margin: "0" }}>Karsana District Specialist</p>
                        </div>
                    </div>
                    <p style={{ fontSize: "14px", color: "var(--text-secondary)", lineHeight: "1.6", marginBottom: "20px" }}>&ldquo;Karsana is one of Abuja's fastest-growing family districts. I'll help you find the right opportunity.&rdquo;</p>
        ...
        <div className="portfolio-container-main" style={{ maxWidth: "1380px", margin: "0 auto", padding: "0 40px" }}>
            ...
            <div className="portfolio-header sidebar-layout" style={{ marginTop: "60px" }}>
                ...
                <h2 className="portfolio-headline" style={{ fontFamily: "'Outfit', sans-serif", fontSize: "42px", fontWeight: "400", lineHeight: "1.1", letterSpacing: "-0.02em", color: "var(--text-primary)", margin: "0", maxWidth: "600px" }}>
                    House types in Karsana District
                </h2>
            </div>
