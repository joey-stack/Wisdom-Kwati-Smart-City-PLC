...
export default function Page() {
    ...
    <section className="pd-hero">
        <div className="pd-hero-image">
            <img src="https://images.weserv.nl/?url=https://drive.google.com/uc?id=1dP8dOZmR2Fg7mUkXUDiByr06e64h50Lh" referrerPolicy="no-referrer" alt="Sunset Haven" />
        </div>
        <div className="pd-hero-overlay"></div>
        <div className="pd-hero-content reveal-on-scroll">
            <h1 className="pd-hero-title">Sunset Haven</h1>
            <p className="pd-hero-description">An elite smart district engineered for premium living, featuring high-fidelity security and future-ready infrastructure in the heart of Abuja.</p>
            <a href="/katampe-extension/updates" className="btn-pill" style={{ marginTop: "30px", display: "inline-flex", background: "var(--accent-green)", color: "var(--text-primary)", border: "none" }}>
            ...
            <div className="pd-left-col">
                ...
                <section className="pd-section reveal-on-scroll">
                    <p style={{ fontSize: "20px", lineHeight: "1.6", color: "var(--text-primary)", marginBottom: "40px" }}>
                        Katampe Extension is Abuja's most ambitious residential undertaking. Designed as a fully integrated smart city district, it combines natural hilly topography with cutting-edge engineering to create a secure, serene, and sophisticated environment for Nigeria's elite.
                    </p>
                    
                    <div className="pd-section-title">District Highlights</div>
                    <ul className="pd-highlights">
                        <li>Underground power cabling system (Zero overhead wires)</li>
                        <li>Dedicated fibre-optic backbone for high-speed internet</li>
                        <li>Advanced storm drainage and erosion control engineering</li>
                        <li>24/7 Rapid Response security patrols & CCTV perimeter</li>
                        <li>Eco-friendly waste management & central sewage treatment</li>
                    </ul>
                </section>
                ...
                <section className="pd-section reveal-on-scroll">
                    ...
                    <div className="pd-table-container">
                        <table className="pd-table">
                            ...
                            <tbody>
                                <tr>
                                    <td className="pd-label-cell">Primary Title</td>
                                    <td>Certificate of Occupancy (C of O)</td>
                                </tr>
                                <tr>
                                    <td className="pd-label-cell">Security Level</td>
                                    <td>Military-Grade Perimeter / Smart AI Surveillance</td>
                                </tr>
                                <tr>
                                    <td className="pd-label-cell">Infrastructure</td>
                                    <td>Advanced Smart Grid / Underground Utilities</td>
                                </tr>
                                <tr>
                                    <td className="pd-label-cell">Atmosphere</td>
                                    <td>Elite / Architectural / High-Privacy</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <section className="pd-section reveal-on-scroll">
                    ...
                    <div className="pd-table-container">
                        <table className="pd-table">
                            ...
                            <tbody>
                                <tr>
                                    <td className="pd-label-cell">Health</td>
                                    <td>Turkish Nizamye Hospital</td>
                                    <td>10 mins</td>
                                </tr>
                                <tr>
                                    <td className="pd-label-cell">Shopping</td>
                                    <td>Jabi Lake Mall</td>
                                    <td>15 mins</td>
                                </tr>
                                <tr>
                                    <td className="pd-label-cell">Aviation</td>
                                    <td>Nnamdi Azikiwe Int'l Airport</td>
                                    <td>35 mins</td>
                                </tr>
                                <tr>
                                    <td className="pd-label-cell">Education</td>
                                    <td>The Regent Secondary School</td>
                                    <td>12 mins</td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <section className="pd-section reveal-on-scroll">
                    ...
                    <div className="pd-table-container">
                        <table className="pd-table">
                            ...
                            <tbody>
                                <tr>
                                    <td className="pd-label-cell">Standard Plots</td>
                                    <td>₦45M – ₦90M</td>
                                    <td>High Demand / Fast Absorption</td>
                                </tr>
                                <tr>
                                    <td className="pd-label-cell">Corner Plots</td>
                                    <td>₦95M – ₦160M</td>
                                    <td>Premium Location Uplift</td>
                                </tr>
                                <tr>
                                    <td className="pd-label-cell">Estate Lots (Bulk)</td>
                                    <td>₦200M – ₦500M+</td>
                                    <td>Developer & Investor Grade</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <section className="pd-section reveal-on-scroll">
                    ...
                    <div className="pd-table-container">
                        <table className="pd-table">
                            ...
                            <tbody>
                                <tr>
                                    <td className="pd-label-cell">Starter Plot</td>
                                    <td>15m × 30m</td>
                                    <td>450 sqm</td>
                                    <td>Available</td>
                                </tr>
                                <tr>
                                    <td className="pd-label-cell">Standard Plot</td>
                                    <td>18m × 36m</td>
                                    <td>648 sqm</td>
                                    <td>Available</td>
                                </tr>
                                <tr>
                                    <td className="pd-label-cell">Executive Plot</td>
                                    <td>20m × 40m</td>
                                    <td>800 sqm</td>
                                    <td>Limited</td>
                                </tr>
                                <tr>
                                    <td className="pd-label-cell">Grand Estate Lot</td>
                                    <td>30m × 60m</td>
                                    <td>1,800 sqm</td>
                                    <td>On Request</td>
                                </tr>
            ...
            <aside className="pd-sidebar">
                ...
                <div className="pd-compact-list reveal-on-scroll">
                    <a href="/karsana-district" className="pd-compact-item">
                        <div className="pd-compact-flipper">
                            <div className="pd-compact-front">
                                <img src="/assets/whispering_pine_card_text.jpg" alt="Karsana" className="pd-compact-thumb" />
                    ...
                    <a href="/guzape-estate" className="pd-compact-item">
                        <div className="pd-compact-flipper">
                            <div className="pd-compact-front">
                                <img src="/assets/nimi_hills_project_card.png" alt="Guzape" className="pd-compact-thumb" />
                                <div className="pd-compact-info">
                    ...
                    <a href="/mabushi-district" className="pd-compact-item">
                        <div className="pd-compact-flipper">
                            <div className="pd-compact-front">
                                <img src="/assets/ellington_villas_project_card.jpg" alt="Mabushi" className="pd-compact-thumb" />
                                <div className="pd-compact-info">
                                    <h4>Ellington Villa 2</h4>
                                    <p>Mabushi District</p>
                                </div>
                            </div>
                            <div className="pd-compact-back">
                                <img src="/assets/ellington_villas_project_card.jpg" alt="Mabushi" className="pd-compact-thumb" />
                ...
                <div className="pd-sidebar-card reveal-on-scroll" style={{ marginTop: "40px", background: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: "4px", padding: "24px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "16px" }}>
                        <img src="/assets/about_company_bg.png" alt="Ahmed Bello" style={{ width: "56px", height: "56px", borderRadius: "4px", objectFit: "cover", flexShrink: "0" }} />
                        <div>
                            <h3 style={{ fontSize: "16px", fontWeight: "700", margin: "0 0 4px" }}>Ahmed Bello</h3>
                            <p style={{ fontSize: "13px", color: "var(--text-secondary)", margin: "0" }}>Sunset Haven Specialist</p>
                        </div>
                    </div>
                    <p style={{ fontSize: "14px", color: "var(--text-secondary)", lineHeight: "1.6", marginBottom: "20px" }}>&ldquo;I specialize in high-net-worth acquisitions within this zone. Let's secure your legacy.&rdquo;</p>
        ...
        <div className="portfolio-container-main" style={{ maxWidth: "1380px", margin: "0 auto", padding: "0 40px" }}>
            ...
            <div className="portfolio-header sidebar-layout" style={{ marginTop: "60px" }}>
                ...
                <h2 className="portfolio-headline" style={{ fontFamily: "'Outfit', sans-serif", fontSize: "42px", fontWeight: "400", lineHeight: "1.1", letterSpacing: "-0.02em", color: "var(--text-primary)", margin: "0", maxWidth: "600px" }}>
                    House types in Katampe Extension
                </h2>
            </div>
