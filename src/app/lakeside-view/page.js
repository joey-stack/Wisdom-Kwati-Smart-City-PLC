...
export default function Page() {
    ...
    <section className="pd-hero">
        <div className="pd-hero-image">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1zk_L-RPdkV8k_sU1ekPayn9SMUYckCXa%26sz=w1200" alt="Lakeside View" referrerPolicy="no-referrer" />
        </div>
        <div className="pd-hero-overlay"></div>
        <div className="pd-hero-content reveal-on-scroll">
            <h1 className="pd-hero-title">Lakeside View</h1>
            <p className="pd-hero-description">A tranquil residential retreat by the water in Kuje.</p>
            <a href="/lakeside-view/updates" className="btn-pill" style={{ marginTop: "30px", display: "inline-flex", background: "var(--accent-green)", color: "var(--text-primary)", border: "none" }}>
    ...
    <div className="container-1380">
        <div className="pd-main-layout">
            ...
            <div className="pd-left-col">
                ...
                <section className="pd-section reveal-on-scroll">
                    <p style={{ fontSize: "20px", lineHeight: "1.6", color: "var(--text-primary)", marginBottom: "40px" }}>
                        Lakeside View offers an unparalleled waterfront living experience in Kuje. Designed for ultimate tranquility, the estate blends the serenity of nature with advanced smart city infrastructure, providing residents with a peaceful yet highly connected lifestyle.
                    </p>
                    
                    <div className="pd-section-title">District Highlights</div>
                    <ul className="pd-highlights">
                        
            <li>Waterfront promenades and lush parks</li>
            <li>Gated secure perimeter with AI surveillance</li>
            <li>Smart home ready infrastructure</li>
            <li>Dedicated leisure and clubhouse facilities</li>
            <li>Eco-friendly waste and water management</li>
            ...
            <tr><td className="pd-label-cell">Atmosphere</td><td>Tranquil / Natural / Serene</td></tr>
            ...
            <tr><td className="pd-label-cell">Standard Plots</td><td>₦20M – ₦50M</td><td>High Capital Appreciation</td></tr>
            <tr><td className="pd-label-cell">Waterfront Plots</td><td>₦60M – ₦90M</td><td>Exclusive Views</td></tr>
            <tr><td className="pd-label-cell">Estate Lots (Bulk)</td><td>₦150M+</td><td>Developer Grade Investment</td></tr>
                ...
                <div className="pd-sidebar-card reveal-on-scroll" style={{ marginTop: "40px", background: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: "4px", padding: "24px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "16px" }}>
                        ...
                        <div>
                            ...
                            <p style={{ fontSize: "13px", color: "var(--text-secondary)", margin: "0" }}>Lakeside View Specialist</p>
                        </div>
                    </div>
                    <p style={{ fontSize: "14px", color: "var(--text-secondary)", lineHeight: "1.6", marginBottom: "20px" }}>&ldquo;Lakeside View is our most peaceful development, offering an incredible waterfront lifestyle without compromising on smart city amenities.&rdquo;</p>
