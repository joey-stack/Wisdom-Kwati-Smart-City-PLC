...
export default function Page() {
    ...
    <section className="pd-hero">
        <div className="pd-hero-image">
            <img src="/assets/ellington_villas_project_card.jpg" alt="Ellington Villa" />
        </div>
        <div className="pd-hero-overlay"></div>
        <div className="pd-hero-content reveal-on-scroll">
            <h1 className="pd-hero-title">Ellington Villa</h1>
            <p className="pd-hero-description">A vibrant, centrally located district offering seamless connectivity and modern urban living within Abuja's inner ring.</p>
            <a href="/mabushi-district/updates" className="btn-pill" style={{ marginTop: "30px", display: "inline-flex", background: "var(--accent-green)", color: "var(--text-primary)", border: "none" }}>
    ...
    <main className="container-1380">
        <div className="pd-main-layout">
            ...
            <div className="pd-left-col">
                ...
                <section className="pd-section reveal-on-scroll">
                    <p style={{ fontSize: "20px", lineHeight: "1.6", color: "var(--text-primary)", marginBottom: "40px" }}>
                        Ellington Villa is the ultimate urban connector. Located at the heart of Abuja's inner ring road system, it offers unparalleled access to all major districts. Our smart developments here are engineered for those who value efficiency, security, and the pulse of the city.
                    </p>
                    
                    <div className="pd-section-title">District Highlights</div>
                    <ul className="pd-highlights">
                        
            <li>Paved inner-ring road boulevards</li>
            <li>Centralized fiber-optic internet connection</li>
            <li>Advanced smart street lighting systems</li>
            <li>24/7 Gated security & AI access control</li>
            <li>Walking distance to major commercial hubs</li>
            ...
            <tr><td className="pd-label-cell">Security Level</td><td>High-fidelity Perimeter / Gated</td></tr>
            <tr><td className="pd-label-cell">Infrastructure</td><td>Urban Smart Utility Grid</td></tr>
            <tr><td className="pd-label-cell">Atmosphere</td><td>Dynamic / Central / Secure</td></tr>
            ...
            <tr><td className="pd-label-cell">Health</td><td>Limi Hospital</td><td>8 mins</td></tr>
            <tr><td className="pd-label-cell">Shopping</td><td>Next Cash & Carry</td><td>5 mins</td></tr>
            <tr><td className="pd-label-cell">Aviation</td><td>Airport</td><td>35 mins</td></tr>
            <tr><td className="pd-label-cell">Education</td><td>Creative Learning School</td><td>10 mins</td></tr>
            ...
            <tr><td className="pd-label-cell">Standard Plots</td><td>₦40M – ₦85M</td><td>Stable Investment Growth</td></tr>
            <tr><td className="pd-label-cell">Corner Plots</td><td>₦90M – ₦150M</td><td>High Commercial Value</td></tr>
            <tr><td className="pd-label-cell">Estate Lots (Bulk)</td><td>₦200M – ₦450M+</td><td>Prime Development Grade</td></tr>
            ...
            <tr><td className="pd-label-cell">Commercial lot</td><td>20m × 40m</td><td>800 sqm</td><td>Limited</td></tr>
                ...
                <div className="pd-sidebar-card reveal-on-scroll" style={{ marginTop: "40px", background: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: "4px", padding: "24px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "16px" }}>
                        ...
                        <div>
                            ...
                            <p style={{ fontSize: "13px", color: "var(--text-secondary)", margin: "0" }}>Mabushi Specialist</p>
                        </div>
                    </div>
                    <p style={{ fontSize: "14px", color: "var(--text-secondary)", lineHeight: "1.6", marginBottom: "20px" }}>&ldquo;Location is everything. Ellington Villa places you right in the center of the action with all the security of a smart estate.&rdquo;</p>
        ...
        <div className="portfolio-container-main" style={{ maxWidth: "1380px", margin: "0 auto", padding: "0 40px" }}>
            ...
            <div className="portfolio-header sidebar-layout" style={{ marginTop: "60px" }}>
                ...
                <h2 className="portfolio-headline" style={{ fontFamily: "'Outfit', sans-serif", fontSize: "42px", fontWeight: "400", lineHeight: "1.1", letterSpacing: "-0.02em", color: "var(--text-primary)", margin: "0", maxWidth: "600px" }}>
                    House types in Ellington Villa
                </h2>
            </div>
