...
export default function Page() {
    ...
    <section className="pd-hero">
        <div className="pd-hero-image">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1y65H-RgWhwbiZ0ZlJKay6Qj4bYtHZL6D%26sz=w1200" alt="Kwati City" referrerPolicy="no-referrer" />
        </div>
        <div className="pd-hero-overlay"></div>
        <div className="pd-hero-content reveal-on-scroll">
            <h1 className="pd-hero-title">Kwati City</h1>
            <p className="pd-hero-description">The pinnacle of luxury expansion, extending the legacy of Abuja's most prestigious neighborhood into a new era of smart living.</p>
            <a href="/maitama-district/updates" className="btn-pill" style={{ marginTop: "30px", display: "inline-flex", background: "var(--accent-green)", color: "var(--text-primary)", border: "none" }}>
    ...
    <div className="container-1380">
        <div className="pd-main-layout">
            ...
            <div className="pd-left-col">
                ...
                <section className="pd-section reveal-on-scroll">
                    <p style={{ fontSize: "20px", lineHeight: "1.6", color: "var(--text-primary)", marginBottom: "40px" }}>
                        Kwati City is the logical evolution of excellence. Designed to meet the demands of Nigeria's highest net worth individuals, this district combines the prestige of traditional Maitama with the future-ready infrastructure of a smart city, ensuring privacy, power, and prestige.
                    </p>
                    
                    <div className="pd-section-title">District Highlights</div>
                    <ul className="pd-highlights">
                        
            <li>Military-grade perimeter security & drone patrols</li>
            <li>Ultra-premium smart utility grid (24/7 Power)</li>
            <li>Dedicated ultra-high-speed fiber network</li>
            <li>Elite private parks & exclusive boulevards</li>
            <li>Automated access control & smart waste systems</li>
            ...
            <tr><td className="pd-label-cell">Security Level</td><td>Ultra-Elite / Armed Response</td></tr>
            <tr><td className="pd-label-cell">Infrastructure</td><td>Full-Scale Smart Grid</td></tr>
            <tr><td className="pd-label-cell">Atmosphere</td><td>Regal / Private / Exclusive</td></tr>
            ...
            <tr><td className="pd-label-cell">Health</td><td>Maitama District Hospital</td><td>10 mins</td></tr>
            <tr><td className="pd-label-cell">Shopping</td><td>Transcorp Hilton Arcade</td><td>12 mins</td></tr>
            <tr><td className="pd-label-cell">Aviation</td><td>Airport</td><td>45 mins</td></tr>
            <tr><td className="pd-label-cell">Education</td><td>International Community School</td><td>15 mins</td></tr>
            ...
            <tr><td className="pd-label-cell">Standard Plots</td><td>₦100M – ₦200M</td><td>Stable Elite Demand</td></tr>
            <tr><td className="pd-label-cell">Corner Plots</td><td>₦220M – ₦350M</td><td>High Asset Recognition</td></tr>
            <tr><td className="pd-label-cell">Estate Lots (Bulk)</td><td>₦500M – ₦1.2B+</td><td>Global Investment Grade</td></tr>
            ...
            <tr><td className="pd-label-cell">Grand Estate Plot</td><td>30m × 60m</td><td>1,800 sqm</td><td>Available</td></tr>
            <tr><td className="pd-label-cell">Ambassadorial Lot</td><td>50m × 100m</td><td>5,000 sqm</td><td>On Request</td></tr>
                ...
                <div className="pd-sidebar-card reveal-on-scroll" style={{ marginTop: "40px", background: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: "4px", padding: "24px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "16px" }}>
                        ...
                        <div>
                            ...
                            <p style={{ fontSize: "13px", color: "var(--text-secondary)", margin: "0" }}>Kwati City Specialist</p>
                        </div>
                    </div>
                    <p style={{ fontSize: "14px", color: "var(--text-secondary)", lineHeight: "1.6", marginBottom: "20px" }}>&ldquo;Excellence has no compromise. Kwati City is the ultimate statement of achievement in Abuja.&rdquo;</p>
