        ...
        <main>
            ...
            <section className="pd-hero">
                <div className="pd-hero-image">
                    <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1eMbw99C0kjQqbNZoyN4rieCduY_uNnuZ%26sz=w1200" alt="Palm Haven" style={{ width: "100%", height: "100%", objectFit: "cover", position: "absolute", top: "0", left: "0" }} referrerPolicy="no-referrer" />
                </div>
                <div className="pd-hero-overlay"></div>
                <div className="pd-hero-content reveal-on-scroll">
                    <h1 className="pd-hero-title">Palm Haven</h1>
                    <p className="pd-hero-description">A vibrant, tropical-inspired modern apartment community in Apo Tafyi.</p>
                    <a href="/palm-haven/updates" className="btn-pill" style={{ marginTop: "30px", display: "inline-flex", background: "var(--accent-green)", color: "var(--text-primary)", border: "none" }}>
                    ...
                    <div className="pd-left-col">
                        ...
                        <section className="pd-section reveal-on-scroll">
                            <p style={{ fontSize: "20px", lineHeight: "1.6", color: "var(--text-primary)", marginBottom: "40px" }}>
                                Palm Haven in Apo Tafyi redefines tropical luxury. With beautifully landscaped palm-lined streets and cutting-edge apartment designs, this estate is engineered for young professionals and modern families seeking vibrancy and smart connectivity.
                            </p>
                            <div className="pd-section-title">District Highlights</div>
                            <ul className="pd-highlights">
                                <li>Modern mid-rise smart apartments</li>
                                <li>High-speed fiber-optic connectivity</li>
                                <li>Tropical landscaped community areas</li>
                                <li>24/7 power and security surveillance</li>
                                <li>Integrated smart lighting and cooling</li>
                            </ul>
                        </section>
                            ...
                            <div className="pd-table-container">
                                <table className="pd-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr><td className="pd-label-cell">Security Level</td><td>High / Gated Access</td></tr>
                                        <tr><td className="pd-label-cell">Infrastructure</td><td>Modern Smart Utility Grid</td></tr>
                                        <tr><td className="pd-label-cell">Atmosphere</td><td>Vibrant / Tropical / Modern</td></tr>
                                    </tbody>
                                </table>
                            </div>
                        </section>
                        ...
                        <section className="pd-section reveal-on-scroll">
                            ...
                            <div className="pd-table-container">
                                <table className="pd-table">
                                    ...
                                    <tbody>
                                        <tr><td className="pd-label-cell">Health</td><td>Apo General Hospital</td><td>10 mins</td></tr>
                                        <tr><td className="pd-label-cell">Shopping</td><td>Shoprite Apo</td><td>15 mins</td></tr>
                        ...
                        <section className="pd-section reveal-on-scroll">
                            ...
                            <div className="pd-table-container">
                                <table className="pd-table">
                                    ...
                                    <tbody>
                                        <tr><td className="pd-label-cell">Apartment Units</td><td>₦30M – ₦60M</td><td>High Rental Yield</td></tr>
                                        <tr><td className="pd-label-cell">Penthouses</td><td>₦80M – ₦120M</td><td>Exclusive Views</td></tr>
                            ...
                            <a href="/katampe-extension" className="pd-compact-item">
                                <div className="pd-compact-flipper">
                                    <div className="pd-compact-front">
                                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1xYCnvanRHqSsdCeheY75jtAM5QS3AS0n%26sz=w1200" alt="Sunset Haven" className="pd-compact-thumb"  referrerPolicy="no-referrer"/>
                        ...
                        <div className="pd-sidebar-card reveal-on-scroll" style={{ marginTop: "40px", background: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: "4px", padding: "24px" }}>
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "16px" }}>
                                ...
                                <div>
                                    ...
                                    <p style={{ fontSize: "13px", color: "var(--text-secondary)", margin: "0" }}>Palm Haven Specialist</p>
                                </div>
                            </div>
                            <p style={{ fontSize: "14px", color: "var(--text-secondary)", lineHeight: "1.6", marginBottom: "20px" }}>&ldquo;Palm Haven is designed for the dynamic modern family. It's vibrant, secure, and incredibly well-connected.&rdquo;</p>
