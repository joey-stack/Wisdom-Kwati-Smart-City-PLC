            ...
            <div className="container-1380" style={{ padding: "60px 20px" }}>
                ...
                <div className="gallery-grid reveal-on-scroll">
                    <div className="gallery-item video-item skeleton">
                        <video autoPlay={true} src="https://drive.google.com/uc?export=download&id=1WkaEVNo0ii8zkmYXHDOd5MOFwDcz7VKi" poster="https://images.weserv.nl/?url=drive.google.com/uc?id=1eMbw99C0kjQqbNZoyN4rieCduY_uNnuZ" className="-video" controls muted={true} loop={true} playsInline={true} preload="metadata"></video>
                    </div>
                    <div className="gallery-item skeleton">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1UD9Y32e13MOoV8CRibkuC5bBgHbTzoam" alt="Palm Haven Site Update" loading="lazy" />
                    </div>
                    <div className="gallery-item skeleton">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1B3cgNstWKQojqadbYfvYhldFT961GRPK" alt="Palm Haven Site Update" loading="lazy" />
                    </div>
                    <div className="gallery-item skeleton">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1LYF8aZZPnWhg3my_LJH_GOPzy4AEKppk" alt="Palm Haven Site Update" loading="lazy" />
                    </div>
                    <div className="gallery-item skeleton">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1WyUxduCtGKp5W4B5xZ1liHas9U1oz-3r" alt="Palm Haven Site Update" loading="lazy" />
                    </div>
                    <div className="gallery-item skeleton">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1UD9Y32e13MOoV8CRibkuC5bBgHbTzoam" alt="Palm Haven Site Update" loading="lazy" />
                    </div>
