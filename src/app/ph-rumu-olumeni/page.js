...
export default function Page() {
    ...
    <main className="container-1380">
        <div className="pd-main-layout">
            ...
            <tr><td className="pd-label-cell">Infrastructure</td><td>Modern Utilities / Coastal Grid</td></tr>
            <tr><td className="pd-label-cell">Atmosphere</td><td>Coastal / Sophisticated / Secure</td></tr>
            ...
            <tr><td className="pd-label-cell">Health</td><td>Ignatius Ajuru Clinic</td><td>10 mins</td></tr>
            <tr><td className="pd-label-cell">Shopping</td><td>Port Harcourt Mall</td><td>25 mins</td></tr>
            <tr><td className="pd-label-cell">Aviation</td><td>PH International Airport</td><td>40 mins</td></tr>
            <tr><td className="pd-label-cell">Education</td><td>Ignatius Ajuru University</td><td>5 mins</td></tr>
            ...
            <tr><td className="pd-label-cell">Standard Plots</td><td>₦15M – ₦35M</td><td>Strong Asset Appreciation</td></tr>
            <tr><td className="pd-label-cell">Corner Plots</td><td>₦40M – ₦70M</td><td>Premium Asset Value</td></tr>
            <tr><td className="pd-label-cell">Estate Lots (Bulk)</td><td>₦120M – ₦250M+</td><td>Developer Grade Investments</td></tr>
