        ...
        <main>
            ...
            <section className="pd-hero">
                <div className="pd-hero-image">
                    <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1UlrWanL0sHutgi7BJQqadeXWXY9G3jLm%26sz=w1200" alt="Garden Eden Estate" referrerPolicy="no-referrer" />
                </div>
                <div className="pd-hero-overlay"></div>
                <div className="pd-hero-content reveal-on-scroll">
                    <h1 className="pd-hero-title">Garden Eden Estate</h1>
                    <p className="pd-hero-description">A high-fidelity residential enclave in the Garden City, engineered for security and sophisticated coastal-influenced living.</p>
                    ...
                    <div className="pd-left-col">
                        ...
                        <section className="pd-section reveal-on-scroll">
                            <p style={{ fontSize: "20px", lineHeight: "1.6", color: "var(--text-primary)", marginBottom: "40px" }}>
                                Garden Eden Estate is Port Harcourt's premier smart residential undertaking. Designed to thrive in the unique coastal environment of Rivers State, it features advanced drainage engineering, 24/7 security patrols, and a sustainable utility grid designed for the elite Port Harcourt resident.
                            </p>
                            <div className="pd-section-title">District Highlights</div>
                            <ul className="pd-highlights">
                                <li>Advanced coastal drainage & flood control systems</li>
                                <li>Paved boulevards with smart LED lighting</li>
                                <li>24/7 Security patrols & armed rapid response</li>
                                <li>Dedicated fiber-optic internet infrastructure</li>
                                <li>Community parks & sophisticated green zones</li>
                            </ul>
                        </section>
                            ...
                            <div className="pd-table-container">
                                <table className="pd-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr><td className="pd-label-cell">Security Level</td><td>High-fidelity Perimeter Monitoring</td></tr>
                                        <tr><td className="pd-label-cell">Infrastructure</td><td>Modern Utilities / Smart Grid</td></tr>
                                        <tr><td className="pd-label-cell">Atmosphere</td><td>Elite / Garden City Sophistication</td></tr>
                                    </tbody>
                                </table>
                            </div>
                        </section>
                        ...
                        <section className="pd-section reveal-on-scroll">
                            ...
                            <div className="pd-table-container">
                                <table className="pd-table">
                                    ...
                                    <tbody>
                                        <tr><td className="pd-label-cell">Health</td><td>Military Hospital PH</td><td>15 mins</td></tr>
                                        <tr><td className="pd-label-cell">Shopping</td><td>Spar Mall</td><td>20 mins</td></tr>
                                        <tr><td className="pd-label-cell">Aviation</td><td>PH International Airport</td><td>45 mins</td></tr>
                                        <tr><td className="pd-label-cell">Education</td><td>University of Port Harcourt</td><td>25 mins</td></tr>
                                    </tbody>
                                </table>
                            </div>
                        </section>
                        ...
                        <section className="pd-section reveal-on-scroll">
                            ...
                            <div className="pd-table-container">
                                <table className="pd-table">
                                    ...
                                    <tbody>
                                        <tr><td className="pd-label-cell">Standard Plots</td><td>₦20M – ₦45M</td><td>Strong Asset Appreciation</td></tr>
                                        <tr><td className="pd-label-cell">Corner Plots</td><td>₦50M – ₦80M</td><td>Premium Asset Value</td></tr>
                                        <tr><td className="pd-label-cell">Estate Lots (Bulk)</td><td>₦150M – ₦350M+</td><td>Developer Portfolio Assets</td></tr>
                                    </tbody>
                                </table>
                            </div>
                        </section>
                            ...
                            <div className="pd-table-container">
                                <table className="pd-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr><td className="pd-label-cell">Standard Plot</td><td>18m × 36m</td><td>648 sqm</td><td>Available</td></tr>
                                        <tr><td className="pd-label-cell">Executive Plot</td><td>20m × 40m</td><td>800 sqm</td><td>Limited</td></tr>
                                    </tbody>
                                </table>
                            </div>
                        </section>
                    ...
                    <aside className="pd-sidebar">
                        ...
                        <div className="pd-compact-list reveal-on-scroll">
                            <a href="/katampe-extension" className="pd-compact-item">
                                <div className="pd-compact-flipper">
                                    <div className="pd-compact-front">
                                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1low4QaMMGv78ejUu8fu4jGET-05Ou612%26sz=w1200" alt="Sunset Haven" className="pd-compact-thumb"  referrerPolicy="no-referrer"/>
                            ...
                            <a href="/guzape-estate" className="pd-compact-item">
                                <div className="pd-compact-flipper">
                                    <div className="pd-compact-front">
                                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1AfA4qAiAd3NQPFRkujrl_Or6dAgG-QqP%26sz=w1200" alt="Nimi Hills" className="pd-compact-thumb"  referrerPolicy="no-referrer"/>
                                        <div className="pd-compact-info">
                                            <h4>Nimi Hills</h4>
                                            <p>Guzape</p>
                                        </div>
                        ...
                        <div className="pd-sidebar-card reveal-on-scroll" style={{ marginTop: "40px", background: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: "4px", padding: "24px" }}>
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "16px" }}>
                                <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1goE51ZAEevUwmkKAEARqbVFdtDyFCvLa%26sz=w1200" alt="Samuel Kwati" style={{ width: "56px", height: "56px", borderRadius: "4px", objectFit: "cover", flexShrink: "0" }} referrerPolicy="no-referrer" />
                                <div>
                            ...
                            <p style={{ fontSize: "14px", color: "var(--text-secondary)", lineHeight: "1.6", marginBottom: "20px" }}>&ldquo;Experience the Garden City with a new level of security and smart living. Garden Eden is your gateway to modern luxury in Port Harcourt.&rdquo;</p>
                ...
                <div className="portfolio-container-main" style={{ maxWidth: "1380px", margin: "0 auto", padding: "0 40px" }}>
                    ...
                    <div className="portfolio-header sidebar-layout" style={{ marginTop: "60px" }}>
                        ...
                        <h2 className="portfolio-headline" style={{ fontFamily: "'Outfit', sans-serif", fontSize: "42px", fontWeight: "400", lineHeight: "1.1", letterSpacing: "-0.02em", color: "var(--text-primary)", margin: "0", maxWidth: "600px" }}>
                            House types in Garden Eden Estate
                        </h2>
                    </div>
