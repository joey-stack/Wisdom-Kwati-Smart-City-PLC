        ...
        <div className="pd-main-layout">
            ...
            <aside className="pd-sidebar">
                ...
                <div className="pd-sidebar-card reveal-on-scroll" style={{ marginTop: "40px", background: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: "4px", padding: "24px" }}>
                    ...
                    <p style={{ fontSize: "14px", color: "var(--text-secondary)", lineHeight: "1.6", marginBottom: "20px" }}>&ldquo;Experience the Garden City with a new level of security and smart living. IPO 1 is your gateway to modern luxury in Port Harcourt.&rdquo;</p>
