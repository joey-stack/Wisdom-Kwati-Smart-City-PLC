                ...
                <div className="neighborhood-grid" id="project-grid">
                       ...
                       data-state="adamawa" data-neighborhood="yola" data-estate="fintiri extension">
                        <div className="neighborhood-image-wrapper">
                            <div className="neighborhood-image-inner">
                                <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1QZOdlWzkHofdW-Gq3ANQo7qjnfhYtRvT%26sz=w1200" alt="Fintiri Extension, Yola" referrerPolicy="no-referrer" />
                            </div>
                        </div>
                    ...
                    <a href="/sunbrook-estate" className="neighborhood-card reveal-on-scroll" 
                       data-state="adamawa" data-neighborhood="yola" data-estate="sunbrook estate">
                        <div className="neighborhood-image-wrapper">
                            <div className="neighborhood-image-inner">
                                <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1NrQeDHmLJe2GmoBAwiJCB5sBvn_LXDNM%26sz=w1200" alt="Sunbrook Estate, Yola" referrerPolicy="no-referrer" />
                            </div>
                        </div>
                        <div className="neighborhood-info">
                            <div className="neighborhood-details">
