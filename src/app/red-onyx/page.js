...
export default function Page() {
    ...
    <div id="gallery-lightbox" className="hd-lightbox" aria-hidden="true">
        ...
        <div className="hd-lightbox-thumbs" id="lb-thumbs">
            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1EvTJIVwYq5NcbH33A3opCXBuNFyWNS92" alt="1" data-index="0" />
            ...
            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1EvTJIVwYq5NcbH33A3opCXBuNFyWNS92"  alt="5" data-index="4" />
        </div>

        {/*  Hidden full src list  */}
        <div id="lb-srcs" style={{ display: "none" }}>
            <span>https://images.weserv.nl/?url=drive.google.com/uc?id=1EvTJIVwYq5NcbH33A3opCXBuNFyWNS92</span>
        ...
        <div className="hd-hero-image">
            <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1EvTJIVwYq5NcbH33A3opCXBuNFyWNS92" alt="The Red Onyx" />
        </div>
            ...
            <div className="hd-left-col">
                ...
                <section className="hd-gallery reveal-on-scroll">
                    <div className="hd-gallery-item hd-gal-1">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1EvTJIVwYq5NcbH33A3opCXBuNFyWNS92" alt="Property View 1" />
                    </div>
                    ...
                    <div className="hd-gallery-item hd-gal-5">
                        <img src="https://images.weserv.nl/?url=drive.google.com/uc?id=1EvTJIVwYq5NcbH33A3opCXBuNFyWNS92" alt="Property View 5" />
                    </div>
