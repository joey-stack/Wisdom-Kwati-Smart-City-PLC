...
export default function Page() {
    ...
    <section className="pd-hero">
        <div className="pd-hero-image">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1iymAgUmz0NeL8RyNb2HAEk-XHMYHR7j9%26sz=w1200" alt="Royal City" referrerPolicy="no-referrer" />
        </div>
        <div className="pd-hero-overlay"></div>
        <div className="pd-hero-content reveal-on-scroll">
            <h1 className="pd-hero-title">Royal City</h1>
            <p className="pd-hero-description">Majestic detached living in the heart of Kuje.</p>
            <a href="/royal-city/updates" className="btn-pill" style={{ marginTop: "30px", display: "inline-flex", background: "var(--accent-green)", color: "var(--text-primary)", border: "none" }}>
    ...
    <div className="container-1380">
        <div className="pd-main-layout">
            ...
            <div className="pd-left-col">
                ...
                <section className="pd-section reveal-on-scroll">
                    <p style={{ fontSize: "20px", lineHeight: "1.6", color: "var(--text-primary)", marginBottom: "40px" }}>
                        Royal City offers a majestic residential experience in Kuje, Abuja. This exclusive estate features expansive detached homes, grand architectural designs, and an uncompromised level of smart security, making it a true kingdom for its residents.
                    </p>
                    
                    <div className="pd-section-title">District Highlights</div>
                    <ul className="pd-highlights">
                        
            <li>Grand detached architectural designs</li>
            <li>Maximum security and AI surveillance</li>
            <li>Underground premium utility networks</li>
            <li>Exclusive clubhouse and sports facilities</li>
            <li>Lush, manicured streetscapes</li>
            ...
            <tr><td className="pd-label-cell">Security Level</td><td>Maximum / Gated Access</td></tr>
            <tr><td className="pd-label-cell">Infrastructure</td><td>Premium Smart Utility Grid</td></tr>
            <tr><td className="pd-label-cell">Atmosphere</td><td>Majestic / Exclusive / Grand</td></tr>
            ...
            <tr><td className="pd-label-cell">Standard Plots</td><td>₦30M – ₦60M</td><td>High Capital Appreciation</td></tr>
            <tr><td className="pd-label-cell">Premium Plots</td><td>₦70M – ₦100M</td><td>Exclusive Views</td></tr>
            ...
            <aside className="pd-sidebar">
                ...
                <div className="pd-sidebar-card reveal-on-scroll" style={{ marginTop: "40px", background: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: "4px", padding: "24px" }}>
                    ...
                    <p style={{ fontSize: "14px", color: "var(--text-secondary)", lineHeight: "1.6", marginBottom: "20px" }}>&ldquo;Royal City is built for those who desire grandeur and unmatched privacy. It's truly a majestic place to live.&rdquo;</p>
