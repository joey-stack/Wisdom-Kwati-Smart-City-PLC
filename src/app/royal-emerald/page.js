...
export default function Page() {
    ...
    <div id="gallery-lightbox" className="hd-lightbox" aria-hidden="true">
        ...
        <div className="hd-lightbox-caption">
            <strong>The Royal Emerald</strong> &mdash; Guzape II
        </div>
        ...
        <div id="lb-srcs" style={{ display: "none" }}>
            <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1low4QaMMGv78ejUu8fu4jGET-05Ou612%26sz=w1200</span>
            <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1pZw-Bbw-n7F6cLhweMXVkXN8EDU0mlIT%26sz=w1200</span>
            <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ%26sz=w1200</span>
            <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1VBqCbd9wcYZK-027SKQoy1-t1eofVjdL%26sz=w1200</span>
            <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1low4QaMMGv78ejUu8fu4jGET-05Ou612%26sz=w1200</span>
        </div>
    </div>
        <div className="hd-hero-image">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1low4QaMMGv78ejUu8fu4jGET-05Ou612%26sz=w1200" alt="The Royal Emerald" referrerPolicy="no-referrer" />
        </div>
        ...
        <div className="hd-hero-content reveal-on-scroll">
            ...
            <h1 className="hd-hero-title">The Royal Emerald</h1>
            <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "18px", letterSpacing: "0.05em", opacity: "0.9", marginTop: "-10px" }}>5 Bedroom Fully Detached Duplex</p>
        </div>
    </section>
        ...
        <div className="hd-specs-bar-wrapper">
            <div className="hd-specs-bar">
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">8,200 sq ft</span>
                </div>
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">WKSC-EM-002</span>
                </div>
            </div>
        ...
        <div className="hd-main-grid">
            ...
            <div className="hd-left-col">
                ...
                <section className="hd-description reveal-on-scroll">
                    <p className="hd-description-text">The Royal Emerald is a sanctuary of sophistication, offering five en-suite bedrooms, multiple lounges, and a state-of-the-art kitchen. Designed for families who value space and luxury.</p>
                </section>
                ...
                <div className="hd-sidebar">
                    ...
                    <div className="hd-inquiry-box reveal-on-scroll">
                        ...
                        <form className="hd-inquiry-form">
                            ...
                            <div className="hd-form-group">
                                <textarea rows="4" placeholder="I'm interested in The Royal Emerald. Please provide more details."></textarea>
                            </div>
    ...
    <section className="hd-related-section reveal-on-scroll">
        <div className="hd-container">
            ...
            <div className="portfolio-grid" id="related-properties-grid">
                {/*  Related Listing 1: Imperial Emerald  */}
