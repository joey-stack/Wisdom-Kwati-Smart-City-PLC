...
export default function Page() {
    ...
    <div id="gallery-lightbox" className="hd-lightbox" aria-hidden="true">
        ...
        <div className="hd-lightbox-caption">
            <strong>The Silver Pearl</strong> &mdash; Life Camp
        </div>
        ...
        <div className="hd-lightbox-thumbs" id="lb-thumbs">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D%26sz=w1200" alt="1" data-index="0" referrerPolicy="no-referrer" />
            ...
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D%26sz=w1200"  alt="5" data-index="4" referrerPolicy="no-referrer" />
        </div>

        {/*  Hidden full src list  */}
        <div id="lb-srcs" style={{ display: "none" }}>
            <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D%26sz=w1200</span> <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1low4QaMMGv78ejUu8fu4jGET-05Ou612%26sz=w1200</span> <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1pZw-Bbw-n7F6cLhweMXVkXN8EDU0mlIT%26sz=w1200</span> <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1VBqCbd9wcYZK-027SKQoy1-t1eofVjdL%26sz=w1200</span> <span>https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D%26sz=w1200</span>
    </div>
    </div>
        <div className="hd-hero-image">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D%26sz=w1200" alt="The Silver Pearl" referrerPolicy="no-referrer" />
        </div>
        ...
        <div className="hd-hero-content reveal-on-scroll">
            ...
            <h1 className="hd-hero-title">The Silver Pearl</h1>
            <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "18px", letterSpacing: "0.05em", opacity: "0.9", marginTop: "-10px" }}>3 Bedroom Apartment</p>
        </div>
    </section>
        ...
        <div className="hd-specs-bar-wrapper">
            <div className="hd-specs-bar">
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">2,100 sq ft</span>
                </div>
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">WKSC-PE-001</span>
                </div>
            </div>
        ...
        <div className="hd-main-grid">
            ...
            <div className="hd-left-col">
                ...
                <section className="hd-description reveal-on-scroll">
                    <p className="hd-description-text">The Silver Pearl offers luxurious apartment living with modern amenities and a prime location. Perfect for professionals and families looking for a sophisticated urban home.</p>
                </section>

                {/*  Bento Gallery  */}
                <section className="hd-gallery reveal-on-scroll">
                    <div className="hd-gallery-item hd-gal-1">
                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D%26sz=w1200" alt="Property View 1" referrerPolicy="no-referrer" />
                    </div>
                    ...
                    <div className="hd-gallery-item hd-gal-5">
                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=https://drive.google.com/thumbnail?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D%26sz=w1200" alt="Property View 5" referrerPolicy="no-referrer" />
                    </div>
                ...
                <section className="hd-amenities-section reveal-on-scroll">
                    ...
                    <div className="hd-amenities-grid">
                        <div className="hd-amenity-tag"><i className="fa-solid fa-water"></i> Swimming Pool</div>
                        <div className="hd-amenity-tag"><i className="fa-solid fa-dumbbell"></i> Fitness Center</div>
                        ...
                        <div className="hd-amenity-tag"><i className="fa-solid fa-wifi"></i> High-Speed Internet</div>
                    </div>
                </section>
                ...
                <div className="hd-sidebar">
                    ...
                    <div className="hd-inquiry-box reveal-on-scroll">
                        ...
                        <form className="hd-inquiry-form">
                            ...
                            <div className="hd-form-group">
                                <textarea rows="4" placeholder="I'm interested in The Silver Pearl. Please provide more details."></textarea>
                            </div>
