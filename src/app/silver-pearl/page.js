...
export default function Page() {
    ...
    <div id="gallery-lightbox" className="hd-lightbox" aria-hidden="true">
        ...
        <div className="hd-lightbox-thumbs" id="lb-thumbs">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=drive.google.com/uc?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D" alt="1" data-index="0" />
            ...
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=drive.google.com/uc?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D"  alt="5" data-index="4" />
        </div>

        {/*  Hidden full src list  */}
        <div id="lb-srcs" style={{ display: "none" }}>
            <span>https://images.weserv.nl/?output=webp&q=80&url=drive.google.com/uc?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D</span>
        ...
        <div className="hd-hero-image">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=drive.google.com/uc?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D" alt="The Silver Pearl" />
        </div>
            ...
            <div className="hd-left-col">
                ...
                <section className="hd-gallery reveal-on-scroll">
                    <div className="hd-gallery-item hd-gal-1">
                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=drive.google.com/uc?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D" alt="Property View 1" />
                    </div>
                    ...
                    <div className="hd-gallery-item hd-gal-5">
                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=drive.google.com/uc?id=1cBO3as-XL4ecKLz_xur4TxlVn1eqbi4D" alt="Property View 5" />
                    </div>
