...
export default function Page() {
    ...
    <div id="gallery-lightbox" className="hd-lightbox" aria-hidden="true">
        ...
        <div className="hd-lightbox-caption">
            <strong>The Star Sapphire</strong> &mdash; Katampe Extension
        </div>
        ...
        <div className="hd-lightbox-thumbs" id="lb-thumbs">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=drive.google.com/uc?id=19sBRWuZx6VQ-enPz4-9UlWgyfrGLKVX-" alt="1" data-index="0" />
            ...
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=drive.google.com/uc?id=19sBRWuZx6VQ-enPz4-9UlWgyfrGLKVX-"  alt="5" data-index="4" />
        </div>

        {/*  Hidden full src list  */}
        <div id="lb-srcs" style={{ display: "none" }}>
            <span>https://images.weserv.nl/?output=webp&q=80&url=drive.google.com/uc?id=19sBRWuZx6VQ-enPz4-9UlWgyfrGLKVX-</span>
        ...
        <div className="hd-hero-image">
            <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=drive.google.com/uc?id=19sBRWuZx6VQ-enPz4-9UlWgyfrGLKVX-" alt="The Star Sapphire" />
        </div>
        ...
        <div className="hd-hero-content reveal-on-scroll">
            ...
            <h1 className="hd-hero-title">The Star Sapphire</h1>
            <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "18px", letterSpacing: "0.05em", opacity: "0.9", marginTop: "-10px" }}>4 Bedroom Fully Detached Pent-House</p>
        </div>
    </section>
        ...
        <div className="hd-specs-bar-wrapper">
            <div className="hd-specs-bar">
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">600 SQM</span>
                </div>
                <div className="hd-spec-item">
                ...
                <div className="hd-spec-item">
                    ...
                    <span className="hd-spec-value">WKSC-SA-001</span>
                </div>
            </div>
        ...
        <div className="hd-main-grid">
            ...
            <div className="hd-left-col">
                ...
                <section className="hd-description reveal-on-scroll">
                    <p className="hd-description-text">The Star Sapphire is a jewel of functional design and smart technology. Every square inch has been optimized for comfort, resulting in a home that feels both intimate and grand. With premium automation features and sustainable infrastructure, its the ultimate smart investment.</p>
                </section>

                {/*  Bento Gallery  */}
                <section className="hd-gallery reveal-on-scroll">
                    <div className="hd-gallery-item hd-gal-1">
                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=drive.google.com/uc?id=19sBRWuZx6VQ-enPz4-9UlWgyfrGLKVX-" alt="Property View 1" />
                    </div>
                    ...
                    <div className="hd-gallery-item hd-gal-4">
                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=drive.google.com/uc?id=1EM6PEbCKWutwdjTCdT-8wLCm3qtmkSJJ" alt="Property View 4" />
                    </div>
                    <div className="hd-gallery-item hd-gal-5">
                        <img loading="lazy" src="https://images.weserv.nl/?output=webp&q=80&url=drive.google.com/uc?id=19sBRWuZx6VQ-enPz4-9UlWgyfrGLKVX-" alt="Property View 5" />
                    </div>
                ...
                <div className="hd-sidebar">
                    ...
                    <div className="hd-inquiry-box reveal-on-scroll">
                        ...
                        <form className="hd-inquiry-form">
                            ...
                            <div className="hd-form-group">
                                <textarea rows="4" placeholder="I'm interested in The Star Sapphire. Please provide more details."></textarea>
                            </div>
