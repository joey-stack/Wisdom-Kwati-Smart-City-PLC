...
export default function Page() {
    ...
    <section className="pd-hero">
        <div className="pd-hero-image">
            <img src="/assets/wisdom_kwati_karshi_card.jpg" alt="Wisdom Kwati Smart City" />
        </div>
        <div className="pd-hero-overlay"></div>
        <div className="pd-hero-content reveal-on-scroll">
            <h1 className="pd-hero-title">Wisdom Kwati Smart City</h1>
            <p className="pd-hero-description">Our flagship ultra-modern megacity project in Karshi, Abuja.</p>
            <a href="/wisdom-kwati-smart-city/updates" className="btn-pill" style={{ marginTop: "30px", display: "inline-flex", background: "var(--accent-green)", color: "var(--text-primary)", border: "none" }}>
    ...
    <main className="container-1380">
        <div className="pd-main-layout">
            ...
            <div className="pd-left-col">
                ...
                <section className="pd-section reveal-on-scroll">
                    <p style={{ fontSize: "20px", lineHeight: "1.6", color: "var(--text-primary)", marginBottom: "40px" }}>
                        Wisdom Kwati Smart City in Karshi is the crown jewel of our portfolio. It is a fully integrated megacity designed to showcase the pinnacle of smart urban planning, sustainable energy, and ultra-modern architecture.
                    </p>
                    
                    <div className="pd-section-title">District Highlights</div>
                    <ul className="pd-highlights">
                        
            <li>Flagship smart megacity infrastructure</li>
            <li>100% renewable energy integration</li>
            <li>Advanced AI traffic and security systems</li>
            <li>World-class commercial and leisure hubs</li>
            <li>Premium ultra-modern residential zones</li>
            ...
            <tr><td className="pd-label-cell">Security Level</td><td>Maximum / City-Wide AI</td></tr>
            <tr><td className="pd-label-cell">Infrastructure</td><td>Ultra-Modern Smart Grid</td></tr>
            <tr><td className="pd-label-cell">Atmosphere</td><td>Futuristic / Premium / Majestic</td></tr>
            ...
            <tr><td className="pd-label-cell">Health</td><td>Karshi General Hospital</td><td>10 mins</td></tr>
            <tr><td className="pd-label-cell">Shopping</td><td>Future WKSC Mega Mall</td><td>0 mins</td></tr>
            <tr><td className="pd-label-cell">Aviation</td><td>Nnamdi Azikiwe Int. Airport</td><td>45 mins</td></tr>
            <tr><td className="pd-label-cell">Education</td><td>Future WKSC University</td><td>0 mins</td></tr>
            ...
            <tr><td className="pd-label-cell">Standard Plots</td><td>₦50M – ₦100M</td><td>High Capital Appreciation</td></tr>
            <tr><td className="pd-label-cell">Premium Plots</td><td>₦120M – ₦250M</td><td>Exclusive Views</td></tr>
            <tr><td className="pd-label-cell">Commercial Lots</td><td>₦300M+</td><td>Developer Grade Investment</td></tr>
                ...
                <div className="pd-sidebar-card reveal-on-scroll" style={{ marginTop: "40px", background: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: "4px", padding: "24px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "16px" }}>
                        ...
                        <div>
                            ...
                            <p style={{ fontSize: "13px", color: "var(--text-secondary)", margin: "0" }}>Megacity Specialist</p>
                        </div>
                    </div>
                    <p style={{ fontSize: "14px", color: "var(--text-secondary)", lineHeight: "1.6", marginBottom: "20px" }}>&ldquo;Wisdom Kwati Smart City is the future of urban living in Africa. It is an unparalleled investment in tomorrow's infrastructure.&rdquo;</p>
        ...
        <div className="portfolio-container-main" style={{ maxWidth: "1380px", margin: "0 auto", padding: "0 40px" }}>
            ...
            <div className="portfolio-header sidebar-layout" style={{ marginTop: "60px" }}>
                ...
                <h2 className="portfolio-headline" style={{ fontFamily: "'Outfit', sans-serif", fontSize: "42px", fontWeight: "400", lineHeight: "1.1", letterSpacing: "-0.02em", color: "var(--text-primary)", margin: "0", maxWidth: "600px" }}>
                    House types in Wisdom Kwati Smart City
                </h2>
            </div>
